...
<body>
<nav id="navigation">
    <a id="chngloc" href="#cloc">Change Location?<img src="location.png" width="18" height="15"></a>
    <div class="modal" id="cloc">
        <div class="modal-container">
            <p id="citylist">
                <a href="C:\Users\HEMAL MANIAR\Desktop\BT\2\Home page\index_mumbai.html">Mumbai</a><br>
                <a href="C:\Users\HEMAL MANIAR\Desktop\BT\2\Home page\index_pune.html">Pune</a><br>
                <a href="C:\Users\HEMAL MANIAR\Desktop\BT\2\Home page\index_delhi.html">New Delhi</a><br>
                <a href="#">Close</a>
            </p>
        </div>
    </div>
    ...
    <section class="movielist">
        <article class="mov">
            <article class="movdescript">
                  <p class="movtitle"><?php echo $m_name1; ?></p>
                    <a href="C:\xampp\htdocs\MOVIE\try.html">
        ...
        <article class="mov">
            <article class="movdescript">
                ...
                <button class="book">BOOK NOW</button>
                <article class="movdetails">
                    <img src="clock.png" width="15" height="15"><font color="red">MINUTES :  <?php echo $r2; ?></font><br>
        ...
        <article class="mov">
            <article class="movdescript">
                ...
                <button class="book">BOOK NOW</button>
                <article class="movdetails">
                    <img src="clock.png" width="15" height="15"><font color="red">MINUTES :  <?php echo $r3; ?></font><br>
        ...
        <article class="mov">
            <article class="movdescript">
                ...
                <button class="book">BOOK NOW</button>
                <article class="movdetails">
                    <img src="clock.png" width="15" height="15"><font color="red">MINUTES :  <?php echo $r4; ?></font><br>
        ...
        <article class="mov">
            <article class="movdescript">
                ...
                <button class="book">BOOK NOW</button>
                <article class="movdetails">
                    <img src="clock.png" width="15" height="15"><font color="red"> MINUTES :  <?php echo $r5; ?></font><br>
        ...
        <article class="mov">
            <article class="movdescript">
                ...
                <button class="book">BOOK NOW</button>
                <article class="movdetails">
                    <img src="clock.png" width="15" height="15"><font color="red"> MINUTES :  <?php echo $r6; ?></font><br>
