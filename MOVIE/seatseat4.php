...
$fetch="SELECT seat FROM register WHERE b_date='$b_date' AND b_time='$b_time' AND movie_name='$m_name4' ";
...
$_SESSION['m_name4'] = $ro['movie_name'];
$m_name4=$_SESSION['m_name4'];
    ...
    <secion class="page">
        <div class="demo">
            ...
            <div class="booking-details">
                <p>Movie: <span><?php echo $m_name4 ; ?> </span></p>
