...
$fetch="SELECT seat FROM register WHERE b_date='$b_date' AND b_time='$b_time' AND movie_name='$m_name1' ";
...
$_SESSION['m_name1'] = $ro['movie_name'];
$m_name1=$_SESSION['m_name1'];
    ...
    <section class="page">
        <div class="demo">
            ...
            <div class="booking-details">
                <p>Movie: <span><?php echo $m_name1 ; ?> </span></p>
                ...
                <a href="qr.php">
                <button class="checkout-button" onclick="showseat()" id="buy" disabled>BUY</button></a>
