...
$fetch="SELECT seat FROM register WHERE b_date='$b_date' AND b_time='$b_time' AND movie_name='$m_name5' ";
...
$_SESSION['m_name5'] = $ro['movie_name'];
$m_name5=$_SESSION['m_name5'];
    ...
    <section class="page">
        <div class="demo">
            ...
            <div class="booking-details">
                <p>Movie: <span><?php echo $m_name5 ; ?> </span></p>
